...
/// <param name="Outcome">What <see cref="Done"/> did with the response; Rejected when the adapter itself failed, Skipped when the pack exceeded the budget.</param>
...
public sealed record RunProgress(string UnitId, UnitKind Kind, string Key, int Attempt, DoneOutcome Outcome, string Message, int Completed, int Total);
