...
public static class HelpText
{
    ...
    public static string? For(string command) => command switch
    {
        ...
        "fix" => "usage: codemuster fix --agent <name> [options]\n\n"
            ...
            + "  --allow-failing-tests Skip the test_command check on the unmodified tree\n"
            ...
            + "It first runs once on the unmodified tree; if it fails, cannot start, or changes tracked files,\n"
            + "fix stops before any agent call and prints its last lines.\n"
